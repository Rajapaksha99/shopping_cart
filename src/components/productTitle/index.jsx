  ...
  return (
    <div className="relative group border border-cyan-700 p-6 cursor-pointer">
      ...
      <div className="flex items-start justify-between mt-4 space-x-4">
        <div className="font-bold text-grey-900 sm:text-sm text -xs md:text-base">
          <p className="w-[100px] pverflow-hidden text-ellipsis whitespace-nowrap">{singleProductTile?.title}
          </p>
        </div>
      ...
      <button onClick={()=> handleNavigateToProductDetailsPage(singleProductTile?.id)} className="px-5 mt-5 w-full py-2 rounded-none bg-black text-white font-bold text-large">View Details</button>
    </div>
  );
}
